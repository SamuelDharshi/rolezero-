...
// import { useCurrentAccount } from '@mysten/dapp-kit'; // Currently unused
import { formatTimestamp, getRoleStatus } from '@/utils/dateUtils';
import { useAllRoles } from '@/hooks/useAllRoles';
// Removed unused format import - using formatTimestamp from utils
import { Clock, Wallet, Users, Receipt } from 'lucide-react';
...
export const RolesList: React.FC = () => {
  ...
  // const suiAccount = useCurrentAccount(); // Would be used for user-specific filtering
  ...
  // Centralized date utilities now in utils/dateUtils.ts
    ...
    <div className="container roles-list-page">
      ...
      {!roles || roles.length === 0 ? (
        ...
        <div className="roles-grid">
          {roles.map((role) => {
            const statusInfo = getRoleStatus(role.startTime, role.expiryTime);
            ...
            return (
              ...
              >
                ...
                <div className="role-card-creator">
                  Creator: <ENSAddress address={role.creator} showAvatar={true} maxLength={15} />
                </div>
                ...
                <div className="role-card-footer">
                  <div className="expiry-info">
                    <Clock size={14} />
                    <span>Expires {formatTimestamp(role.expiryTime)}</span>
                  </div>
