  ...
  return (
    <div className="sponsor-info">
      <div className="sponsor-identity">
        <Wallet size={16} />
        <ENSAddress address={address} showAvatar={true} maxLength={20} />
      </div>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card card">
          ...
          <div className="stat-value">
            <Clock size={20} />
            {formatTimestamp(roleData.expiryTime, 'MMM d, yyyy')}
          </div>
          <div className="stat-sublabel">{formatTimestamp(roleData.expiryTime, 'HH:mm')}</div>
        </div>
      </div>
                    ...
                    {event.type === 'funding' ? (
                      ...
                      <>
                        ...
                        <div className="timeline-recipient">
                          To: <ENSAddress address={event.data.recipient} maxLength={15} />
                        </div>
                      </>
                    )}
                ...
                <div key={index} className={`payment-item ${isExecuted ? 'executed' : ''}`}>
                  <div className="payment-info">
                    <div className="payment-recipient">
                      <ENSAddress address={payment.recipient} showAvatar={true} showCopy={true} maxLength={25} />
                    </div>
                    <div className="payment-time">
                      {formatTimestamp(payment.scheduledTime, 'MMM d, yyyy HH:mm')}
                    </div>
                  </div>
