...
export const UserProfile: React.FC = () => {
  ...
  // Developer addresses (in production, this would be from config)
  const DEVELOPER_ADDRESSES = [
    '0x7cd3b3519b8f7e5033cc3b4ce7ce846c9cd507ed47991cf44bf097895a7de547', // Arc
    suiAccount?.address,
    evmAddress,
  ].filter(Boolean);
  ...
  return (
    <div className="container profile-page">
      ...
      <div className="dashboard-header">
        <div>
          <h1>
            <LetterSwapForward label={activeTab === 'developer' ? 'Developer Analytics' : 'User Dashboard'} />
          </h1>
          <p className="dashboard-subtitle">
            <LetterSwapForward 
              label={activeTab === 'developer' 
                ? 'Platform metrics, revenue insights, and user analytics'
                : 'Real-time transaction monitoring across all users'} 
            />
          </p>
        </div>
